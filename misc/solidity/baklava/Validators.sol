...
interface IReserve {
    ...
    function transferExchangeGold(address payable, uint256)
        external
        returns (bool);
    ...
    CalledByVm
{
    ...
    modifier onlySlasher() {
        require(
            getLockedGold().isSlasher(msg.sender),
        ...
        returns (bool)
    {
            ...
            LockedGoldRequirements storage requirements
    ...
    function registerValidator(
        ...
        uint256 lockedGoldBalance = getLockedGold().getAccountTotalLockedGold(
            account
        );
        require(
            lockedGoldBalance >= validatorLockedGoldRequirements.value,
            "Deposit too small"
        );
    ...
    function _distributeEpochPaymentsFromSigner(
        ...
        if (
            meetsAccountLockedGoldRequirements(account) &&
            meetsAccountLockedGoldRequirements(group)
        ) {
            ...
            uint256 groupPayment = totalPayment
                ...
                .fromFixed();
            uint256 validatorPayment = totalPayment.fromFixed().sub(
                groupPayment
            );
        ...
        returns (bool)
    {
        ...
        uint256 requirementEndTime = validator
            ...
            .add(validatorLockedGoldRequirements.duration);
        ...
        returns (bool)
    {
        ...
        require(
            lockedGoldBalance >= groupLockedGoldRequirements.value,
    ...
    function _addMember(
        ...
        require(
            meetsAccountLockedGoldRequirements(validator),
    ...
    function getAccountLockedGoldRequirement(address account)
        public
        view
        returns (uint256)
    {
    ...
    function meetsAccountLockedGoldRequirements(address account)
        public
        view
        returns (bool)
    {
