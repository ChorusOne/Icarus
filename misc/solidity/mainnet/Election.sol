    ...
    CalledByVm
{
    ...
    function getGroupEpochRewards(
        ...
        if (
            !validators.meetsAccountLockedGoldRequirements(group) ||
        ...
        returns (uint256)
    {
        uint256 numerator = getValidators()
            ...
            .add(1)
            .mul(getLockedGold().getTotalLockedGold());
    ...
    function electValidatorSigners()
        external
        view
        onlyWhenNotFrozen
        returns (address[] memory)
    ...
    function electNValidatorSigners(
        ...
        uint256[] memory keys = new uint256[](electionGroups.length);
            ...
            FixidityLib.Fraction[] memory votesForNextMember
         = new FixidityLib.Fraction[](electionGroups.length);
    ...
    function forceDecrementVotes(
        ...
        external
        nonReentrant
        onlyRegisteredContract(LOCKED_GOLD_REGISTRY_ID)
        returns (uint256)
    {
